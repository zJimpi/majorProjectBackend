...
//	}
	...
	//new update method
	@PutMapping("/updatePackage/{id}")
	public PackageDto updatePackage(@PathVariable("id") Long packageId, @RequestBody PackageDto packageDetailsDto)
	{
		Package packageEntity = packageConverter.convertDtoToEntity(packageDetailsDto);
		
		return packageService.updatePackage(packageId, packageEntity);	
	}
...
//	public ResponseEntity<List<SpotDto>> updateSpotsForPackage(@PathVariable("packageId") Long packageId,
...
//	public ResponseEntity<String> deleteSpotFromPackage(@PathVariable("packageId") Long packageId,
...
//
//			// Return a response indicating successful deletion
//			return new ResponseEntity<>(spotId + " is deleted from package " + packageId + " successfully!!",
//					HttpStatus.OK);
//		} else {
//			// Handle the case where the package with the given ID does not exist
//			// ...
